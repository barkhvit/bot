...
namespace Bot.Core.Services
{
    public interface IToDoService
    {
        ...
        Task MarkCompleted(Guid id, CancellationToken cancellationToken);//делает задачу завершенной
        ...
        Task<IReadOnlyList<ToDoItem>> GetAllByUserIdAndList(Guid userId, Guid? listId, CancellationToken ct);
